...
/**
 * Admin layout - extends dashboard layout
 */
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 h-screen w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        <a
          href="/admin"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400"
        >
